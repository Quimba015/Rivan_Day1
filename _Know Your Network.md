...
Task:
 1. CoreTAAS must have the following SVIs
   ...
   - VLAN 10
     - IP address: 10.42.10.2
     - Description: WIFI-VLAN
     - Status: UP

   - VLAN 50
     - IP address: 10.42.50.2
...
conf t
 ...
 ip route 10.42.0.0 255.255.0.0 10.42.42.4 254
 end
~~~
...
conf t
 ip routing
 ip route 0.0.0.0 0.0.0.0 10.42.100.4 254
 end
~~~
